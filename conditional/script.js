...
window.onload = function() {
    // Task 1: candidate eligibility based on age using prompt
    ...
    // Task 2:  switch the case of each letter in a string using prompt
    function switchCase() {
    ...
    // Task 3: capitalize the first letter of each word and remove spaces using prompt
    ...
    // Task 4:  remove a specific element from an array using prompt
    ...
    // Task 5: check if a number is odd or even using prompt
    ...
    // Task 6:  check if a variable is a number using prompt
    function isNumber() {
    ...
    // Task 7:  find the largest of two numbers using prompt
    ...
    // Task 8:  check if a triangle is equilateral, scalene, or isosceles using prompt
    ...
    // Task 9:  check if a number is in a range using prompt
    function isInRange() {
    ...
    // Task 10:  check if a year is a leap year using prompt
    function isLeapYear() {
